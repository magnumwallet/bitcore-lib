...
var CURRENT_VERSION = 2; //@NOTE this version number could potentially be the issue (original value 1)
...
Transaction.prototype.anondest = function(address) {
  // console.log('anondest', address);
  $.checkArgument(address, 'anondest is required');
